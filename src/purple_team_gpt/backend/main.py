...
# Include routers
from purple_team_gpt.backend.routers import (
    auth,
    users,
    sessions,
    websocket,
...
# Auth and users routers define their own prefix
app.include_router(auth.router)
app.include_router(users.router)
# Other routers have prefix set here
